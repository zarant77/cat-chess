...
static int packed_sprite_pivot_x(const PackedSpriteDefinition *definition)
{
    return (int)definition->pivot_x;
}

static int packed_sprite_pivot_y(const PackedSpriteDefinition *definition)
{
    return (int)definition->pivot_y;
}
...
void generated_sprite_initialize_all(void)
{
    ...
    for (size_t sprite_index = 0; sprite_index < GENERATED_SPRITE_COUNT; ++sprite_index)
    {
        ...
        sprite->pivot_x = (int16_t)packed_sprite_pivot_x(definition);
        sprite->pivot_y = (int16_t)packed_sprite_pivot_y(definition);
